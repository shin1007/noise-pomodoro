...
const strings: UiStrings = {
  ...
  timer: {
    ...
    none: 'Ninguno',
    minutesUnit: (n) => `${n} min`,
    sleepGuardNote: 'No disponible mientras el Pomodoro está en marcha. Reinícielo para usarlo.',
    pomodoroGuardNote: 'No disponible mientras el temporizador de sueño está en marcha.',
    start: 'Iniciar',
    resume: 'Reanudar',
    pause: 'Pausar',
    reset: 'Reiniciar',
